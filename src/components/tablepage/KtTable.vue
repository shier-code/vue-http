<template>
  <div>
    ...
    <el-table :data="data.content" :highlight-current-row="highlightCurrentRow" @selection-change="selectionChange" 
          @current-change="handleCurrentChange" v-loading="loading" :border="border" :stripe="stripe"
      ...
      <el-table-column  width="185" fixed="right" v-if="showOperation" header-align="center" align="center">
